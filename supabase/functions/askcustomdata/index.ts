...
export const supabaseClient = createClient(
  "https://nlfosazvjwobwyigzyso.supabase.co",
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5sZm9zYXp2andvYnd5aWd6eXNvIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTY5MjgwNzg5OSwiZXhwIjoyMDA4MzgzODk5fQ.7cUXM4rdE2kazYFds1gDE_x8E-LgKp_V5MnZfN9HUz0"
);
...
serve(async (req) => {
  ...
  const configuration = new Configuration({
    apiKey: "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",
  });
